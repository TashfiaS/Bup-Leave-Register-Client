            ...
            <TableRow>
              {columns.map((column) => (
                <TableCell
                  ...
                  sx={{backgroundColor:"gray",color:"white",fontWeight:"bold"}}
                >
                  {column.label}
                </TableCell>
              ))}
                    ...
                    {columns.map((column) => {
                      ...
                      return (
                        <TableCell key={column.id} align={column.align}>
                          <span style={value==="Approved"?ApproveStyle:value==="Rejected"?RejectedStyle:value==="Pending"?PendingStyle:{}}>{column.format && typeof value === 'number'
                            ? column.format(value)
                            : value}</span>
                        </TableCell>
                      );
